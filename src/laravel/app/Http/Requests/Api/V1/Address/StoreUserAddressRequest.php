...
class   StoreUserAddressRequest extends FormRequest
{
     ...
     *
     * Только авторизованные пользователи могут добавлять адреса.
     *
    ...
    /**
     * Преобразует валидированные данные в DTO для создания адреса.
     *
     * @return CreateAddressDto Объект DTO.
     */
    public function toDto(): CreateAddressDto
    {
        $data = $this->validated();
